...
#vc = cv2.VideoCapture(0) #(kalo mau pake camera)
#vc = cv2.VideoCapture('cctv1.mp4')
vc = cv2.VideoCapture("rtsp://admin:samit123@10.3.48.201:554/cam/realmonitor?channel=13&subtype=0")


net = cv2.dnn.readNet("yolov4-tiny-custom_best (1).weights", "yolov4-tiny-custom (4).cfg")
